...
def test_data(railway)
  ...
  cargo_train1 = CargoTrain.new(railway, "Pitsburg Porter")
  cargo_wagon1 = CargoWagon.new(railway)
  cargo_train1.attach_wagon(cargo_wagon1)

  passenger_train1 = PassengerTrain.new(railway, "Washington Express")
  ...
  cargo_train2 = CargoTrain.new(railway, "New York Lofter")
end
